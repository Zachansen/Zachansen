 ...
 * Kept compact (~500 tokens) to minimize API costs.
 * Detailed framework guides are loaded on-demand via tool calls.
 */
 ...
 * These let the AI load frameworks and save data on-demand.
 */
  ...
  },
  {
    ...
    input_schema: {
      ...
      properties: {
        ...
        deadline: {
          type: "string" as const,
          description: "When this should be done (ISO date string or relative like 'today', 'tomorrow', 'this week')",
        },
      },
      required: ["text"],
    },
